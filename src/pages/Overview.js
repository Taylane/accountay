...
function Overview() {
  ...
  async function fetchData() {
    let res = await fetch(
      apiUrl +
        "/transactions?date_like=2021-" +
        dateSelected.getMonth().toString().padStart(2, "0") +
        "&recurrency_ne=1"
    );
      ...
      <div className="Overview">
        <div id="Div-Page-Header">
          <div id="Month-Selector">
            <span className="Page-Header-Item">
              {dateSelected.toLocaleDateString("default", { month: "long" })}
            </span>
            <span className="Page-Header-Item">
            ...
            <ExpandMoreIcon
              ...
              style={{ width: "2.2188rem", height: "2.125rem" }}
            />
          </div>
          <div>
            <Button
